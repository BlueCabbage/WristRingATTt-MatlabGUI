function sub_f_callback(s, BytesAvailable, handles, editout, edit, edit11, edit21, edit31, ...
    edit12, edit22, edit32, edit13, edit23, edit33, edit14, edit24, edit34, edit15, edit25, ...
    edit35, edit16, edit26, edit36, edit17, edit27, edit37)
    ...
    global offset_x2 offset_y2 offset_z2 offset_g_x2 offset_g_y2 offset_g_z2 offset_a_x2 offset_a_y2 offset_a_z2;
    ...
    % % %     
        ...
        set(edit12, 'string', sprintf('%8.4f', dat_tmp(4,1)));
        set(edit22, 'string', sprintf('%8.4f', dat_tmp(5,1)));
        set(edit32, 'string', sprintf('%8.4f', dat_tmp(6,1)));

        set(edit13, 'string', sprintf('%8.4f', dat_tmp(7,1)));
        set(edit23, 'string', sprintf('%8.4f', dat_tmp(8,1)));
        set(edit33, 'string', sprintf('%8.4f', dat_tmp(9,1)));
    ...
    if  data_tmp(1) == 2
        ...
        dat_tmp(1,1) = data2(2) - offset_x2;
        dat_tmp(2,1) = data2(3) - offset_y2;
        dat_tmp(3,1) = data2(4) - offset_z2;

        dat_tmp(4,1) = data2(5) - offset_g_x2;
        dat_tmp(5,1) = data2(6) - offset_g_y2;
        dat_tmp(6,1) = data2(7) - offset_g_z2;

        dat_tmp(7,1) = data2(8) - offset_a_x2;
        dat_tmp(8,1) = data2(9) - offset_a_y2;
        dat_tmp(9,1) = data2(10) - offset_a_z2;
    ...
    % % %     
        ...
        set(edit14, 'string', sprintf('%8.4f', dat_tmp(1,1)));
        set(edit24, 'string', sprintf('%8.4f', dat_tmp(2,1)));
        set(edit34, 'string', sprintf('%8.4f', dat_tmp(3,1)));

        set(edit15, 'string', sprintf('%8.4f', dat_tmp(4,1)));
        set(edit25, 'string', sprintf('%8.4f', dat_tmp(5,1)));
        set(edit35, 'string', sprintf('%8.4f', dat_tmp(6,1)));

        set(edit16, 'string', sprintf('%8.4f', dat_tmp(7,1)));
        set(edit26, 'string', sprintf('%8.4f', dat_tmp(8,1)));
        set(edit36, 'string', sprintf('%8.4f', dat_tmp(9,1)));
